...
class SumaRiemann1(Scene):
    ...
    def construct(self):
        ...
        self.wait(1)
        self.play(Uncreate(bienvenida), Uncreate(pregunta), run_time=0.5)
        self.wait(0.5)
        ...
        self.play(Write(titulo1), Write(integral1), run_time=1)
        self.wait(1)
        ...
        self.play(Write(tendencias), Transform(area_base, suma_riemann1), run_time=2)
        self.wait(1)
        ...
        grafica1 = VGroup(subintervalos, punto_a, punto_b, curva0, area1)

        self.play(Transform(titulo1, titulo3), run_time=2)
        self.wait(2)
        self.play(Transform(grafica1, definicion_inicial), run_time=3)
        self.wait(3)
        ...
        self.play(Transform(area_base, suma_riemann2),
                  ...
                  Transform(area_aprox1, suma_riemann2), run_time=2)
        self.wait(2)
        ...
        self.wait(2)
        self.play(Transform(titulo1, titulo_integral), run_time=3)
        self.wait(3)
