...
class SumaRiemann1(Scene):
    ...
    def construct(self):
        ...
        self.play(Transform(subintervalos, ax),
                  Write(punto_a), Write(punto_b), run_time=2)
        self.wait(1)
        self.play(Write(curva0), run_time=2)
        self.wait(1)
        ...
        self.play(Uncreate(prev_rectangles), Write(area1))
        self.wait(1)
        ...
        self.play(Transform(grafica1, definicion_inicial),
                  Transform(titulo1, titulo3), run_time=1.5)
        self.wait(1)
        self.play(Write(definicion_media), run_time=1.5)
        self.wait(1)
        self.play(Write(area_aprox1), run_time=1.5)
        self.wait(1)
        ...
        self.wait(1)
        self.play(Write(titulo_integral), run_time=3)
        self.wait(3)
